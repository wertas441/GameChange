...
function ServerErrorState({
    ...
    return (
        <div
            className={clsx('w-full', fullHeight && 'min-h-[60vh] flex items-center justify-center')}
        >
            <div
                className="mx-auto max-w-md rounded-2xl border border-slate-800/80 bg-slate-900/60 p-6 text-center
