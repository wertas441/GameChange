    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                ...
                />
                <div
                    className="absolute inset-0 bg-radial-gradient from-transparent via-slate-950/20 to-slate-950/80
                    pointer-events-none"
                />
            </div>
            ...
            <div className="relative z-10 w-full max-w-4xl flex flex-col items-center text-center gap-10 md:gap-12">
                    <h1 className="text-5xl font-bold tracking-tight text-slate-50 sm:text-6xl lg:text-8xl">
                        <span
                            className="bg-gradient-to-r from-amber-200 via-amber-400 to-orange-400 bg-clip-text
                ...
                <div className="flex flex-col sm:flex-row w-auto gap-5">
                    <Link
                        href="/keys/catalog"
                        className="group relative inline-flex items-center justify-center rounded-xl bg-amber-400 px-8
                        py-3.5 text-base font-bold text-slate-900 transition-all duration-300 hover:bg-amber-300
                    ...
                    <Link
                        ...
                        bg-slate-900/40 px-8 py-3.5 text-base font-semibold text-slate-200 backdrop-blur-sm
                         transition-all duration-300 hover:bg-slate-800/60 hover:border-slate-600 hover:text-white
                         hover:-translate-y-0.5"
                    >
                        Пополнить баланс
                    </Link>
